...
class EconomicChoiceEnv(gym.Env):
    ...
    def __init__(self,
        ...
        self.observation_space = spaces.Box(low=0.0, high=20.1, shape=(OBS_DIM,), dtype=np.float32)
        ...
        self.offer_sets = [(0, 1), (1, 100), (2, 1), (100, 1), (2, 0)]
    ...
    def _select_trial_conditions(self):
        ...
        offer_pairs_BA = [(0, 1), (1, 100), (2, 1), (100, 1), (2, 0)]
    ...
    def _get_observation(self, current_epoch):
        ...
        if current_epoch in [EPOCH_OFFER_DELAY, EPOCH_GO_CHOICE, EPOCH_CHOICE_HOLD]:
            ...
            obs[OBS_N_LEFT] = np.clip(scaled_nL, 0.0, 20.1)
            obs[OBS_N_RIGHT] = np.clip(scaled_nR, 0.0, 20.1)
